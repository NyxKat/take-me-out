...
public class Clubs extends AppCompatActivity implements Adapter.OnPlaceListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mlist.add(new item(R.drawable.epu,"Epu Night Club","Γρ. Λαμπράκη 193"));
        mlist.add(new item(R.drawable.eight,"8Ball Club","Πίνδου 1"));
        mlist.add(new item(R.drawable.jadore,"J'adore Supreme Club","Φωκαίας 1 & Αβέρωφ"));
        mlist.add(new item(R.drawable.casper,"Casper at Verykoko","Παγγαίου 11"));
        mlist.add(new item(R.drawable.trap,"TRAP BASEMENT","Συγγρού 3"));
