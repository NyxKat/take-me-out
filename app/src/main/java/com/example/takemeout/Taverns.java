...
public class Taverns extends AppCompatActivity implements Adapter.OnPlaceListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mlist.add(new item(R.drawable.fwlia,"Νέα Φωλιά","Αριστομένους 4 "));
        mlist.add(new item(R.drawable.ouzeri,"Ουζέρι το Νησί ","Πολυτεχνείου 18"));
        mlist.add(new item(R.drawable.glikanisos,"Γλυκάνισος","Μεγάλου Αλεξάνδρου 46"));
        mlist.add(new item(R.drawable.negroponte,"Negroponte","Αιγύπτου 24 Κατούνη 21"));
        mlist.add(new item(R.drawable.kivotos,"Κιβωτός των Γεύσεων","Πατριάρχου Ιωακείμ 26"));
        mlist.add(new item(R.drawable.palati,"Palati","Πλατεία Μοριχόβου 6"));
