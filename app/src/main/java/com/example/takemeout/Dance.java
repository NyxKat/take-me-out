...
public class Dance extends AppCompatActivity implements Adapter.OnPlaceListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mlist.add(new item(R.drawable.ksar,"Ξαρχάκος coffee & drinks","Πάρκο ΧΑΝΘ"));
        mlist.add(new item(R.drawable.larosa,"La Rosa Negra Latin Club","Καρατάσου 3"));
        mlist.add(new item(R.drawable.tango,"Tango Bar","Διαμ. Ολυμπίου 19"));
        mlist.add(new item(R.drawable.habanita,"Habanita Latin Bar","Περιστερίου 6"));
