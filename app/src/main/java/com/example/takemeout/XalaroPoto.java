...
public class XalaroPoto extends AppCompatActivity implements Adapter.OnPlaceListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mlist.add(new item(R.drawable.paraty_and_loft,"Paraty and Loft","Πίνδου 8, Λαδάδικα"));
        mlist.add(new item(R.drawable.lenas,"Lena's Bistro","Κατούνη 7"));
        mlist.add(new item(R.drawable.senor,"Senor","Προξένου Κορομηλά 1"));
        mlist.add(new item(R.drawable.one,"ONE","Καρόλου Ντήλ 1"));
        mlist.add(new item(R.drawable.red_rose_bar,"Red Rose Bar","Στοά Βενιζέλου"));
